...
func _test_descriptor_registration_stages_profile_data() -> bool:
	...
	var descriptor := AutoVoxelFixture.make_runtime_profile_descriptor()
...
func _test_equivalent_descriptors_reuse_profile_id() -> bool:
	...
	var container = RuntimeProfileContainerScript.new()
	var descriptor_a := AutoVoxelFixture.make_runtime_profile_descriptor()
	descriptor_a.asset_id = "asset_a"
	descriptor_a.object_type = "vegetation"
	var descriptor_b := AutoVoxelFixture.make_runtime_profile_descriptor()
...
func _test_profile_registration_is_stable() -> bool:
	...
	var profile_a := AutoVoxelFixture.make_runtime_profile()
	var profile_b := AutoVoxelFixture.make_runtime_profile()
