...
const CommonTestUtilsScript := preload("res://scripts/common_test_utils.gd")
...
func get_contract_source_docs() -> Array:
	return CommonDemoContractUtils.source_docs_from_values(
		get_meta("source_doc", ""),
...
func _cpu_fallback_failures(text: String) -> Array:
	...
	if CommonTestUtilsScript.mentions_no_rd_cpu_success(lower):
...
static func mentions_no_rd_cpu_success(lower_text: String) -> bool:
	return CommonTestUtilsScript.mentions_no_rd_cpu_success(lower_text)
