...
layout(set = 0, binding = 5, std430) restrict readonly buffer CandidateTiles {
...
void main() {
    ...
    uint candidate_tile_count = uint(max(dispatch_search.x, 0));
    ...
    uint tile_id = candidate_tile_ids[group_index];
