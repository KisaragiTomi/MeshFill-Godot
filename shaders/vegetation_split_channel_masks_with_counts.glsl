...
// Split RGBA vegetation occupancy into four R32F masks and count active pixels.
// Input:
//   set0/binding0: RGBA16F occupancy texture.
// Outputs:
//   set1/binding0..3: R32F masks for RGBA channels.
//   set2/binding0: 4 u32 counters for RGBA channels.
...
layout(set = 2, binding = 0, std430) coherent buffer ChannelCounters {
