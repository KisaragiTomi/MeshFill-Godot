...
本文沿用 [`meshfill-framework.md`](meshfill-framework.md) 和 [`scene-voxel-field-system.md`](scene-voxel-field-system.md) 的体素术语。
...
| 场景 | 说明 | Godot 场景 |
| --- | --- | --- |
| [ScenePlacementActor 编排](../../demos/core-scene-placement-actor/core-scene-placement-actor.md) | 测试方法与验收标准 | [`../../demos/core-scene-placement-actor/core-scene-placement-actor.tscn`](../../demos/core-scene-placement-actor/core-scene-placement-actor.tscn) |
