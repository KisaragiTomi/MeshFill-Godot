...
| Scatter / visual helper | `scatter_min_distance`、`scatter_max_count`、`scatter_max_scale`、`visual_layer`、`group`、`material` | 当前多用于 vegetation descriptor / 实例化辅助；不进入 committed `SceneVoxel` accepted fields。 |
